...
task('prepareTx:ac:grantRoleMult')
    ...
    .setAction(async ({
        ...
        const populatedTx = await acContract.populateTransaction.grantRoleMult(rolesParsed, addressesParsed);
...
task('prepareTx:ac:revokeRoleMult')
    ...
    .setAction(async ({
        ...
        const populatedTx = await acContract.populateTransaction.revokeRoleMult(rolesParsed, addressesParsed);
...
task('prepareTx:ac:grantRole')
    ...
    .setAction(async ({
        ...
        const populatedTx = await acContract.populateTransaction.grantRole(role, address);
...
task('prepareTx:ac:revokeRole')
    ...
    .setAction(async ({
        ...
        const populatedTx = await acContract.populateTransaction.revokeRole(role, address);
...
task('prepareTx:ac:renounceRole')
    ...
    .setAction(async ({
        ...
        const populatedTx = await acContract.populateTransaction.renounceRole(role, address);
